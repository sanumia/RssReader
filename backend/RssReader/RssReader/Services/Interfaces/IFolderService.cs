...
{
    Task<ResponseFolderDto> CreateFolderAsync(int userId, CreateFolderDto createFolderDto, CancellationToken ct = default);
    Task RenameFolderAsync(int userId, int folderId, UpdateFolderDto updateFolderDto, CancellationToken ct = default);
